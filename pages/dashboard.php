    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Student Management & Registration System</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="sidebar-nav navbar-collapse">
                 ...
                 <li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i>Register<span class="fa arrow"></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="register.php">Add Registration</a>
                                </li>
                                <li>
                                    <a href="view-res.php">View Registration</a>
                                </li>
                                <li>
                                    <a href="view-std.php">View Student Info</a>
                                </li>
                            </ul>
                  </li>            
                   <li>
