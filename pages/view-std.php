...
<body>
    ...
    <div id="wrapper">
     ...
     <?php include('leftbar.php')?>;
      ...
      <td><?php echo htmlentities(strtoupper($res->gname));?></td>
      <td><?php echo htmlentities(strtoupper($res->gphonenum));?></td>
      <td><?php echo htmlentities(strtoupper($res->address));?></td>	
      <td><?php echo htmlentities(strtoupper($res->nationality));?></td>
      ...
      <a href="view-std.php?del=<?php echo htmlentities($res->id); ?>">
