...
if(isset($_POST['submit'])){
	 ...
	 // echo  $id=$_GET['cid'];exit;
		//echo $_POST['course-short'].$_POST['course-full'].$_POST['hod'].$id;exit;
	$obj->edit_course($_POST['course-short'],$_POST['course-full'],$_POST['hod'],$id);
...
<input class="form-control" name="course-full" id="cfull" value="<?php echo $res->cfull;?>" required="required"  onblur="coursefullAvail()">         
	<span id="course-status" style="font-size:12px;"></span>				</div>
	 ...
	 <div class="form-group">
		<div class="col-lg-4">
		<label>Head of Department<span id="" style="font-size:11px;color:red">*</span></label>
		</div>
		<div class="col-lg-6">
		<input class="form-control"  name="hod" value="<?php echo $res->hod;?>">
	</div>
	 </div>	
